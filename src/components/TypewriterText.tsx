...
export default function TypewriterText({
    ...
    let typingFunction = (difference:number) => {
        ...
        let newDisplayString = currentString.slice(0, displayedText.length + difference)
    ...
    }, [displayedText, isDeleting, currentIndex, stringsToType, typingSpeed, deletingSpeed, delayBetweenStrings]);
    
    return (
        <Typography sx={textStyle}>{displayedText || "\u00A0"}</Typography>
    );
}